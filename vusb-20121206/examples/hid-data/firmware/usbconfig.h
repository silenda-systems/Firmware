...
#define  USB_CFG_VENDOR_ID     0xc0, 0x16 // = 0x16c0 = 5824 = voti.nl   0x42, 0x42
 ...
 */
#define  USB_CFG_DEVICE_ID     0xdf, 0x05 // obdev's shared PID for HIDs   0x31, 0xe1
 ...
 */
#define USB_CFG_VENDOR_NAME     'a', 'k', 'a', '_', 'L', 'U', 'X', '_'
 ...
 * details.
 */
#define USB_CFG_DEVICE_NAME     'D', 'a', 't', 'a', 'K', 'i', 'l', 'l', 'e', 'r'
#define USB_CFG_DEVICE_NAME_LEN 10
/* Same as above for the device name. If you don't want a device name, undefine
 * the macros. See the file USBID-License.txt before you assign a name if you
 * use a shared VID/PID.
 */
#define USB_CFG_SERIAL_NUMBER   '0', '0', '0', '0', '0', '1' 
